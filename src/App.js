...
function App() {
    ...
    const [showLogin, setShowLogin] = useState(false); // State to toggle login form display
    ...
    // Toggle the login form display when logo is clicked
            ...
            {user ? (
                <div>
                    <div className="header">
                        <div className='logo' onClick={toggleLoginForm} style={{ cursor: 'pointer' }}>
                    ...
                    {/* Conditionally render the login box */}
                    {showLogin && (
